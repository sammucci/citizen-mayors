...
export function InfoHeading({
  ...
  return (
    <Tag className={`group relative inline-flex items-center gap-1.5 ${className ?? ""}`}>
      ...
      <span
        tabIndex={0}
        className="flex h-4 w-4 shrink-0 cursor-help items-center justify-center rounded-full border border-neutral-400 bg-white text-[10px] font-bold leading-none text-neutral-500 shadow-sm outline-none transition hover:scale-110 hover:bg-neutral-100 focus-visible:ring-2 focus-visible:ring-duty-purple/50 focus-visible:ring-offset-2"
